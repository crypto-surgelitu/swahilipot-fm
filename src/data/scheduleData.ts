...
export const allShows: Show[] = [
    {
        ...
        description: "Catch up with the latest news of all kinds, from politics to entertainment, with lively discussions and the best music to start your day.",
    ...
    },
    {
        ...
        description: "Get updated with the highlights of the latest sports news and results, with expert analysis and interviews with sports personalities.",
    ...
    },
    {
        ...
        description: "Join Dorcas Uwiyera and DJ Kams for a mix of music, talk, and entertainment, with the best music to keep you company.",
    ...
    },
    {
        ...
        description: "Get your recipes and cooking updates right and lovely with Shufaa Yakut and Munga Sauti Teule.",
    ...
    },
    {
        ...
        description: "Enjoy a mix of poetry and music with Malenga001 and Cardiac Poet, as they share artists' latest works and favorite tracks.",
    ...
    },
    {
        ...
        host: "DJs, Automated",
        description: "Sit back and enjoy the vibes and music set for the day. Take it easy today and remember to enjoy every minute of the tracks.",
