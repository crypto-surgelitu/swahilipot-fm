...
const LatestNewsSection: React.FC<LatestNewsSectionProps> = ({ latestNews }) => {
  return (
    <section className="container mx-auto px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {latestNews.length > 0 ? (
                ...
                <Card className="overflow-hidden border-gray-200 h-full flex flex-col transition-all duration-300 hover:shadow-md">
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                      ...
                      <Link to={`/news/${article.id}`} className="text-sm font-medium flex items-center">
          ...
          <p className="py-10 text-center text-gray-500 text-lg">We are working to bring you the latest news...</p>
        )}
      </div>
    </section>
  );
